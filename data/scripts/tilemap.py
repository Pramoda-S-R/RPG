...
class Tilemap():
    ...
    def render_layer(self, surf, camera_x, camera_y, layer_type):
        for layer in self.tilemap.get('layers', []):
    ...
    def render_map(self, surf, camera_x, camera_y):
        self.render_layer(surf, camera_x, camera_y, 'tilelayer')

    def render_foreground(self, surf, camera_x, camera_y):
        self.render_layer(surf, camera_x, camera_y, 'foreground')

    def render_collisions(self, surf, camera_x, camera_y):
        self.render_layer(surf, camera_x, camera_y, 'collision')    